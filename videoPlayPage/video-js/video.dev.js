...
vjs.Slider.prototype.onMouseUp = function() {
  var parodebar = document.getElementsByClassName("vjs-volume-bar vjs-slider")[0];
  var progressbarVal =parseInt(parodebar.getAttribute("aria-valuetext"));
  var percentval = document.getElementById("vjs-volume-ll");
  percentval.innerHTML = progressbarVal+"%";
...
vjs.Ll.prototype.createEl = function(){
  return vjs.Component.prototype.createEl.call(this, 'div', {
    className: 'vjs-volume-ll',
    id:"vjs-volume-ll"
    // innerHTML:a
  });
};
...
vjs.VolumeBar.prototype.updateARIAAttributes = function(){
  ...
  // document.getElementById("vjs-volume-ll").innerHTML = "vjs.round(this.player_.volume()*100, 2)+'%'";
  // return vjs.round(this.player_.volume()*100, 2)+'%';
};
